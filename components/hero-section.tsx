        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-foreground">
                <span className="text-balance">Software & Embedded</span>
                <br />
                <span className="text-primary">Systems Engineer</span>
              </h1>
              <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">
                Building full-stack IoT platforms, REST APIs, and ML pipelines — with deep roots in
                embedded systems, 5G, and wireless communications.
              </p>
            </div>
